...
int main(int argc, char *argv[])
{
	...
	// This greatly simplifies the setup of the ImFusion integration since we do not need to manage threading.
	...
	// Force first instantiation of the ImFusionClient singleton to ensure that ImFusionLib is
